...
urlpatterns=[
    ...
    path('fiche_transferts/', views.fiche_transferts, name='fiche_transferts'),
    path('fiche_transfert_centres/', views.fiche_transfert_centres, name='fiche_transfert_centres'),
    path('centres/<int:centre_id>/fiche_transferts/', views.fiche_transfert_centres, name='fichier_transfert_centres'),

    path('centre/', views.creer_centre, name='creer_centre'),
